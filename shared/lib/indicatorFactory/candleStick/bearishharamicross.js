...
const { bearishharamicross } = require("technicalindicators");

/**
 * A candlestick pattern.
 */
class BearishHaramiCrossFactory extends CandleStickFactory {
  /**
   * Setup factory
...
module.exports = BearishHaramiCrossFactory;
