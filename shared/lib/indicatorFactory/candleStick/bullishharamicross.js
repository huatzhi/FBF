...
const { bullishharamicross } = require("technicalindicators");

/**
 * A candlestick pattern.
 */
class BullishHaramiCrossFactory extends CandleStickFactory {
  /**
   * Setup factory
...
module.exports = BullishHaramiCrossFactory;
